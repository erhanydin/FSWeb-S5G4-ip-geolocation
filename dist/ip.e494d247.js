...
function createCard(veri) {
  ...
  var cardUlke = document.createElement("p");
  cardUlke.classList.add("ulke");
  cardUlke.textContent = "(".concat(veri["ülke"], " ").concat(veri["ülkeKodu"], ")");
  cardInfo.appendChild(cardUlke);
  var cardEnlem = document.createElement("p");
  cardEnlem.textContent = "Enlem: ".concat(veri["enlem"], " Boylam: ").concat(veri["boylam"]);
  cardInfo.appendChild(cardEnlem);
  var cardSehir = document.createElement("p");
  cardSehir.textContent = veri["şehir"];
  cardInfo.appendChild(cardSehir);
  var cardSaat = document.createElement("p");
  cardSaat.textContent = "Saat dilimi: ".concat(veri["saatdilimi"]);
  cardInfo.appendChild(cardSaat);
  var cardPara = document.createElement("p");
  cardPara.textContent = "Para birimi: ".concat(veri["parabirimi"]);
  cardInfo.appendChild(cardPara);
  var cardISP = document.createElement("p");
  cardISP.textContent = "ISP: ".concat(veri["isp"]);
